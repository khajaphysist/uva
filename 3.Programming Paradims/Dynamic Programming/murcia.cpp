...
//global variables
int h[1000000], w[1000000], I[1000000], D[1000000];
...
int main(){
  ...
  for (int ji = 0; ji < t; ++ji) {
    ...
    if (maxi >= maxd)cout << "Case " << ji+1 << ". Increasing (" << maxi << "). Decreasing (" << maxd << ")." << endl;
    else cout << "Case " << ji+1 << ". Decreasing (" << maxd << "). Increasing (" << maxi << ")." << endl;;
  }
}
